...
There little difference between including orders for procedures such as angiograms/ECGs or not as a selection criteria. Furthermore, including a cohort with a troponin order (*Only C2*) produces a relatively high sensitivity and precision when compared with the other criteria individually.
Whilst these selection methods produce the highest sensitivity, at the same time, produces the highest number of false positives and thus lowest precision. 
