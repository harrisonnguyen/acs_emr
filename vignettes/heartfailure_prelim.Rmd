  ...
  footnote(i=1,
           ...
           value= as_paragraph(
             c("Cohort defined using heart failure ICD10 primary diagnosis.",
               "Data is from Wang et al.'s reduced ejection fraction cohort between 2013-2015.",
...
secondary_med_table %>%
  ...
  footnote(i=1,
           j=c(2,4,6,8),
           value= as_paragraph(
             c("Cohort defined using heart failure ICD10 primary and secondary diagnosis.",
